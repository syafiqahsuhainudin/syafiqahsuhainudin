            ...
            <div class="container">
                <div class="row">
                    ...
                    <!--== Main Menu Start ==-->
                      ...
                      <%   Integer book_id = (Integer) session.getAttribute("is");%>
                        <%	String book_date = (String)session.getAttribute("a");%>
                     <%	String book_time = (String)session.getAttribute("b");%>
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                              ...
                              <li  class="active"><a href="bookingdetail.jsp">Booking Detail</a></li>
                                <li><a href="receipt.jsp">receipt</a>

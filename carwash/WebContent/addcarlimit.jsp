                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                                ...
                                <li ><a href="customerdetail.jsp">Customer Detail</a></li>
								<li class="active"><a href="addcarlimit.jsp">Car limit</a></li>
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="book-a-car">
                            <form action="insertlimit.jsp" method="post">
                                ...
                                <div class="pick-up-date book-item">
                                    ...
                                    <div class="return-car">
                                        <h4>Car limit:</h4>
                                        <input type="number" placeholder="  Time" name="carlimit_perday"required oninvalid="this.setCustomValidity('Please Enter your time')"/>
                                    </div>
                                </div>
                                <!--== Date Time==-->
        <!--== Package Choose ==-->
...
<br><br>
                          <button class="book-now-btn" type="submit" value="Submit">Add Now</button>
                                </div>
                            </form>

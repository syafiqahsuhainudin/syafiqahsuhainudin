                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                               ...
                               <li ><a href="customerdetail.html">customer detail</a>
				<li class="active"><a href="addcarlimit.html">Add car limit</a>
                            </ul>
                        </nav>
                    </div>
                    <!--== Main Menu End ==-->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="slideshowcontent">
                            <h1>BOOK A CAR WASH TODAY!</h1>
                            <p>FOR 5% DISCOUNT <br> FOR OUR RETURNING CUSTOMERS</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="slideshowcontent">
                            ...
                            <p>FOR AS LOW AS RM 50 A DAY PLUS 15% DISCOUNT <br> FOR OUR RETURNING CUSTOMERS</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="booka-car-content">
                        <form action="index3.html">
                            ...
                            <div class="pick-date bookinput-item">
                                <input id="startDate2" placeholder="start Date" />
                            </div>

                            <div class="retern-date bookinput-item">
                                <input id="endDate2" placeholder=" end Date" />
                            </div>

                            <div class="car-choose bookinput-item">
                                <select class="custom-select">
                                  <option selected>car limit</option>
                                  <option value="10">8 CAR</option>
                                  <option value="20">10 CAR</option>
                                  <option value="30">15 CAR</option>
                                </select>
                            </div>

                            <div class="bookcar-btn bookinput-item">
                                <button type="submit">Add car limit</button>
                            </div>
                        </form>
                    </div>
                </div>

            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        ...
                        <p>Welcome to Boy 21 Auto Spa car wash.Sign up for further detail</p>
                    </div>
                </div>
                <!-- Page Title End -->
            </div>
                	...
                	<div class="login-page-content">
                		<div class="login-form">
							...
							<form action="registercontroller"method="post">
								...
								<input type="text" placeholder="Name" name="cust_name" required oninvalid="this.setCustomValidity('Please Enter your name')">
									
								</div>
							
								<div class="username">
									<input type="number" placeholder="phone number"name="cust_phone" required oninvalid="this.setCustomValidity('Please Enter your phone number')">
								</div>
									<div class="username">
									<input type="email" placeholder="Email"name="cust_email" required oninvalid="this.setCustomValidity('Please Enter email')">
								</div>
								<div class="password">
									<input type="password" placeholder="Password"name=cust_password required oninvalid="this.setCustomValidity('Please Enter password')">
								</div>
								<div class="log-btn">
									<button type="submit" value="submit"><i class="fa fa-check-square"></i> Sign Up</button>
								</div>
							</form>
                		</div>

...
<%@ page import="carwash.model.Bookingdetailbean, carwash.dao.Bookingdetaildao, java.sql.*, java.util.*" %>
<head>
    <meta charset="utf-8">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                                <li><a href="index3.jsp">Home</a>
                               <li class="active"><a href="customerdetail.jsp">customer detail</a>
				<li ><a href="addcarlimit.jsp">Add car limit</a>
...
<% List<Bookingdetailbean> bookings = Bookingdetaildao.getAllBooking();
...
<table border="1">
	...
	<% for(Bookingdetailbean p:bookings){%>
	<tr> 
		<td><%= p.getBook_id() %></td>
		<td><%= p.getCust_name() %></td>
		<td><%= p.getCust_phone() %></td>
		<td><%= p.getCust_email() %></td>
		<td><%= p.getBook_date() %></td>
		<td><%= p.getBook_time() %></td>
		<td><%= p.getCar_plateno() %></td>
		<td><%= p.getCar_name() %></td>
		<td><%= p.getCartype() %></td>
		<td><%= p.getCar_package() %></td>

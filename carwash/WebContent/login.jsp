                	...
                	<div class="login-page-content">
                		<div class="login-form">
							...
							<form action="logincontroller"method="get">
								<div class="username">
									<input type="text" placeholder="Email or Username"name="cust_email"required oninvalid="this.setCustomValidity('Please Enter your email')">
								</div>
								<div class="password">
									<input type="password" placeholder="Password" name="cust_password"required oninvalid="this.setCustomValidity('Please Enter your password')">
								</div>
								<div class="log-btn">

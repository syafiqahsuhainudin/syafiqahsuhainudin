                	...
                	<div class="login-page-content">
                		<div class="login-form">
							...
							<form action="NewFile.jsp"method="get">
								<div class="username">
									<input type="email" placeholder="Email or Username"name="adminusername"required oninvalid="this.setCustomValidity('Please Enter your email')">
								</div>
								<div class="password">
									<input type="password" placeholder="Password" name="adminpass"required oninvalid="this.setCustomValidity('Please Enter your password')">
								</div>
								<div class="log-btn">

                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                                ...
                                <li class="active"><a href="package2.jsp">Package</a></li>
                        ...
                        <div class="book-a-car">
                            <form action="login.jsp" method="post">
                                ...
                                <div class="pick-up-date book-item">
                                    <h4>DATE:</h4>
                                    <input  type = "date" placeholder="Date"name="book_date" />

                                    <div class="return-car">
                                        <h4>TIME:</h4>
                                        <input type="time" placeholder="  Time" name="book_time"/>
                                    </div>
                                </div>
                                <!--== Date Time==-->
        <!--== Package Choose ==-->
				...
				<!--== car plate num ==-->
                                <div class="pick-up-date book-item">
                                    <h4>PLATE NUMBER:</h4>
                                    <input type="text" id="plate" name="car_plateno" placeholder=" Plate Num..">

                                    <div class="return-car">
                                        <h4>CAR NAME:</h4>
                                        <input type="text" id="carname" name="car_name" placeholder=" Your car name..">
                                    </div>
                                <!--== Car Choose ==-->
				 ...
				 <!--== Package Choose ==-->
                                <div class="choose-car-type book-item">
                                    ...
                                    <select class="custom-select"name="car_package">
                                      <option selected>Select</option>

...
<%@ page import="carwash.model.BookingBean, carwash.dao.BookingDao,carwash.controller.bookingcontroller, java.sql.*, java.util.*" %>
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
<!DOCTYPE html>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                            ...
                            <ul>
                              ...
                              <li  class="active"><a href="edit.jsp">Booking Detail</a></li>
...
<!-- Modal -->
    ...
    <table class='table table-bordered'> <tr><td>Book id</td>
 		<td> <input  type = "hidden" placeholder="book_id"name="book_id" value="<c:out value="${booking.book_id}"/>" readonly/></td></tr>
        <tr>
            <td>Book Date</td>
            <td>     <input  type = "date" placeholder="Date"name="book_date" value="<c:out value="${booking.book_date}"/>" /></td>
        </tr>
 
        <tr>
            <td>Book Time</td>
            <td><input type="time" placeholder="  Time" name="book_time"value="<c:out value="${booking.book_time}"/>"/></td>
        </tr>
 
        <tr>
            <td>Car Plate</td>
            <td><input type="text" id="plate" name="car_plateno" placeholder=" Plate Num.."value="<c:out value="${booking.car_plateno}"/>"></td>
        </tr>
 <tr>
            <td>Car name</td>
            <td><input type="text" id="carname" name="car_name" placeholder=" Your car name.."value="<c:out value="${booking.car_name}"/>"></td>
        </tr>
 
        <tr>
            <td>Car type</td>
            <td>      <select class="custom-select" size="1.5"name="cartype">
                                       <option value="<c:out value="${booking.cartype}"/>" >Your CarType is--${booking.cartype}--</option>
                                      <option value="SEDAN">SEDAN</option>
                                      <option value="MPV">MPV</option>
                                      <option value="SUV">SUV</option>
                                       <option value="COMPACT">COMPACT</option>
									  <option value="MOTORCYCLE">MOTORCYCLE</option></select></td>
        </tr>
		  <tr>
            <td>Car Packaged</td>
            <td> <select class="custom-select"size="1.5"name="car_package" >
        ...
        <tr>
            <td colspan="2">
            <button type="submit" class="btn btn-primary" name="btn-save" id="btn-save"value="submit">
